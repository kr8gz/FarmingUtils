...
public class AngleHelperOverlay extends Gui {
    ...
    public static boolean shouldRender() {
        return ConfigManager.enableOverlay.get() && ToggleKeybindHandler.showOverlay.get() && ConfigManager.enableAngleHelper.get() && ToggleKeybindHandler.showAngleHelper.get();
    }

    // TODO fix this ugly copy paste lmao
