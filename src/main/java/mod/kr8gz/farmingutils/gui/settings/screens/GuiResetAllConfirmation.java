...
public class GuiResetAllConfirmation extends ModGuiScreen {
    ...
    public void initGui() {
        ...
        elementList.add(new FixedTextLabel(this, "Do you really want to reset all your settings?", width / 2, height / 2 - 37, 2f));
        elementList.add(new FixedTextLabel(this, "This action is irreversible.", width / 2, height / 2 - 17, 2f));

        elementList.add(new Button(this, width / 4, height / 2 + 2, width / 4 - 4, 32, "Cancel", 1.3f, Colors.WHITE) {
            @Override
        ...
        elementList.add(new Button(this, width / 2 + 4, height / 2 + 2, width / 4 - 4, 32, "Continue", 1.3f, Colors.RED) {
            @Override
            protected void action() {
